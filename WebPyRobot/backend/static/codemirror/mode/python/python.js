...
(function(mod) {
  ...
  var maturePyRobotKeywords = ["getEnemyTankId()", "getTankId()",
        "getCellDistance(cell_1,cell_2)",
        "getCellFromXY(x',y)", "getCellPosX(num_cell)",
        "getCellPosY(num_cell)", "getPosition(id_tank)",
        "getLife(id_tank)", "getPM(id_tank)",
        "getPA(id_tank)", "getRange(id_tank)", "moveTank(num_cell)", "shoot()"];
